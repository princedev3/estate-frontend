...
export const housingFAQs = [
  {
    question: "What factors should I consider when buying a house?",
    answer:
      "You should consider location, budget, mortgage rates, neighborhood safety, proximity to work/schools, and future resale value.",
  },
  {
    question: "How much should I save for a down payment?",
    answer:
      "A standard down payment is 20% of the home's price, but some loans allow as low as 3-5% with mortgage insurance.",
  },
  {
    question: "What is the difference between renting and buying a home?",
    answer:
      "Renting offers flexibility and lower upfront costs, while buying builds equity over time and provides long-term financial stability.",
  },
  {
    question: "How does my credit score affect my ability to buy a home?",
    answer:
      "A higher credit score can help you secure a lower mortgage interest rate, saving you thousands over the life of the loan.",
  },
  {
    question: "What are closing costs when purchasing a home?",
    answer:
      "Closing costs typically range from 2% to 5% of the home price and include fees for appraisal, inspection, title insurance, and lender charges.",
  },
];
